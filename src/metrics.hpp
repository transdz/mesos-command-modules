...
#ifndef __MASTER_MY_ALLOCATOR_MESOS_METRICS_HPP__
#define __MASTER_MY_ALLOCATOR_MESOS_METRICS_HPP__
...
struct Metrics
{
  explicit Metrics(const MyAllocator& allocator);
  ...
  const process::PID<MyAllocator> allocator;
...
#endif // __MASTER_MY_ALLOCATOR_MESOS_METRICS_HPP__

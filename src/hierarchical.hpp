...
typedef HierarchicalAllocatorProcess<DRFSorter, DRFSorter, MyCustomAllocator> HierarchicalDRFResourceSortedSlavesCPUFirstAllocatorProcess;
...
typedef HierarchicalAllocatorProcess<RandomSorter, RandomSorter, MyCustomAllocator> HierarchicalRandomResourceSortedCPUFirstSlavesAllocatorProcess;
